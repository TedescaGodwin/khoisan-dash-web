...
import branchHeadValidationSchema from "form/validation-schema/branch-head-validation-schema";
import { onSaveMember, uploadFiles, getMembers} from "form/services/branch-head-service";
...
export default function HeadSettings() {
  ...
  return (
  <Formik
  initialValues={{ memberId: "", isBranchHead: true}}
  validationSchema={branchHeadValidationSchema}
  onSubmit={onSubmit}
>
      ...
      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
        <div className="rounded-t bg-white mb-0 px-6 py-6">
          <div className="text-center flex justify-between">
            <h6 className="text-blueGray-700 text-xl font-bold"><i className='fas fa-code-branch  mr-2'></i>Applicant | Branch Head</h6>
            <button
        ...
        <div className="flex flex-wrap">
            ...
            <div className="relative w-full mb-3">
              ...
              <input
                type="file"
                onChange={(event) =>
                  handleFileUpload(event.target.files[0], 8)
                }
                className="block
              ...
              <div className="relative w-full mb-3">
               ...
               leadership position by the community concerned
                ...
                <input
                  type="file"
                  onChange={(event) =>
                    handleFileUpload(event.target.files[0], 9)
                  }
                  className="block
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="relative w-full mb-3">
                ...
                <input
                  type="file"
                  onChange={(event) =>
                    handleFileUpload(event.target.files[0], 10)
                  }
                  className="block
                  border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                />
            ...
            <div className="w-full lg:w-6/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="file"
                    onChange={(event) =>
                      handleFileUpload(event.target.files[0], 11)
                    }
                    className="block
                    border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 
